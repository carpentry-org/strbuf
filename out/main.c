...
#include <unistd.h>
#include <signal.h>
#include "/Users/veitheller/Documents/Code/Github/carp/archive/strbuf/src/strbuf.h"
...
// Depth 104
typedef void(*Fn__StringBuf_MUL__Char_void)(StringBuf*, Char);

// Depth 104
typedef String(*Fn__StringBuf_MUL__String)(StringBuf*);

// Depth 104
typedef void(*Fn__StringBuf_MUL__String_MUL__void)(StringBuf*, String*);

// Depth 104
typedef int(*Fn__StringBuf_MUL__int)(StringBuf*);

// Depth 104
typedef void(*Fn__StringBuf_MUL__int_void)(StringBuf*, int);

// Depth 104
typedef void(*Fn__StringBuf_MUL__void)(StringBuf*);

// Depth 104
typedef void(*Fn__StringBuf_void)(StringBuf);
...
// Depth 104
typedef StringBuf(*Fn___StringBuf)();
...
int main(int argc, char** argv) {
    ...
    /* let */ {
        ...
        static String _18 = "hello";
        String *_18_ref = &_18;
        String _48;
        /* let */ {
            StringBuf _23 = StringBuf_create();
            StringBuf sb = _23;
            StringBuf* _29 = &sb; // ref
            static String _30 = "hello";
            String *_30_ref = &_30;
            StringBuf_append_MINUS_str(_29, _30_ref);
            String _46;
            /* let */ {
                StringBuf* _37 = &sb; // ref
                String _38 = StringBuf_to_MINUS_string(_37);
                String s = _38;
                StringBuf_delete(sb);
                String _45 = s;
                _46 = _45;
        ...
        String* _49 = &_48; // ref
        static String _50 = "append-str and to-string";
        String *_50_ref = &_50;
        TestState _51 = Test_assert_MINUS_equal__String_MUL__String(test, _18_ref, _49, _50_ref);
        TestState* _1000011 = &_51; // ref
        test = _1000011;  // (Ref Test.State r307) = (Ref Test.State r307)
        static String _59 = "abc";
        String *_59_ref = &_59;
        String _101;
        /* let */ {
            StringBuf _64 = StringBuf_create();
            StringBuf sb = _64;
            StringBuf* _70 = &sb; // ref
            StringBuf_append_MINUS_char(_70, 97/*'a'*/);
            StringBuf* _76 = &sb; // ref
            StringBuf_append_MINUS_char(_76, 98/*'b'*/);
            StringBuf* _82 = &sb; // ref
            StringBuf_append_MINUS_char(_82, 99/*'c'*/);
            String _99;
            /* let */ {
                StringBuf* _90 = &sb; // ref
                String _91 = StringBuf_to_MINUS_string(_90);
                String s = _91;
                StringBuf_delete(sb);
                String _98 = s;
                _99 = _98;
        ...
        static String _103 = "append-char builds string";
        String *_103_ref = &_103;
        TestState _104 = Test_assert_MINUS_equal__String_MUL__String(test, _59_ref, _102, _103_ref);
        TestState* _1000018 = &_104; // ref
        test = _1000018;  // (Ref Test.State r307) = (Ref Test.State r307)
        static String _112 = "n=42";
        String *_112_ref = &_112;
        String _148;
        /* let */ {
            StringBuf _117 = StringBuf_create();
            StringBuf sb = _117;
            StringBuf* _123 = &sb; // ref
            static String _124 = "n=";
            String *_124_ref = &_124;
            StringBuf_append_MINUS_str(_123, _124_ref);
            StringBuf* _129 = &sb; // ref
            StringBuf_append_MINUS_int(_129, 42);
            String _146;
            /* let */ {
                StringBuf* _137 = &sb; // ref
                String _138 = StringBuf_to_MINUS_string(_137);
                String s = _138;
                StringBuf_delete(sb);
                String _145 = s;
                _146 = _145;
        ...
        String* _149 = &_148; // ref
        static String _150 = "append-int";
        String *_150_ref = &_150;
        TestState _151 = Test_assert_MINUS_equal__String_MUL__String(test, _112_ref, _149, _150_ref);
        TestState* _1000025 = &_151; // ref
        test = _1000025;  // (Ref Test.State r307) = (Ref Test.State r307)
        static String _159 = "ok\r\n";
        String *_159_ref = &_159;
        String _194;
        /* let */ {
            StringBuf _164 = StringBuf_create();
            StringBuf sb = _164;
            StringBuf* _170 = &sb; // ref
            static String _171 = "ok";
            String *_171_ref = &_171;
            StringBuf_append_MINUS_str(_170, _171_ref);
            StringBuf* _176 = &sb; // ref
            StringBuf_append_MINUS_crlf(_176);
            String _192;
            /* let */ {
                StringBuf* _183 = &sb; // ref
                String _184 = StringBuf_to_MINUS_string(_183);
                String s = _184;
                StringBuf_delete(sb);
                String _191 = s;
                _192 = _191;
        ...
        String* _195 = &_194; // ref
        static String _196 = "append-crlf";
        String *_196_ref = &_196;
        TestState _197 = Test_assert_MINUS_equal__String_MUL__String(test, _159_ref, _195, _196_ref);
        TestState* _1000032 = &_197; // ref
        test = _1000032;  // (Ref Test.State r307) = (Ref Test.State r307)
        int _226;
        /* let */ {
            StringBuf _209 = StringBuf_create();
            StringBuf sb = _209;
            int _225;
            /* let */ {
                StringBuf* _216 = &sb; // ref
                int _217 = StringBuf_length(_216);
                int l = _217;
                StringBuf_delete(sb);
                int _224 = l;
                _225 = _224;
        ...
        static String _227 = "empty buffer has length 0";
        String *_227_ref = &_227;
        TestState _228 = Test_assert_MINUS_equal__int_String(test, 0, _226, _227_ref);
        TestState* _1000039 = &_228; // ref
        test = _1000039;  // (Ref Test.State r307) = (Ref Test.State r307)
        int _265;
        /* let */ {
            StringBuf _240 = StringBuf_create();
            StringBuf sb = _240;
            StringBuf* _246 = &sb; // ref
            static String _247 = "hello";
            String *_247_ref = &_247;
            StringBuf_append_MINUS_str(_246, _247_ref);
            int _263;
            /* let */ {
                StringBuf* _254 = &sb; // ref
                int _255 = StringBuf_length(_254);
                int l = _255;
                StringBuf_delete(sb);
                int _262 = l;
                _263 = _262;
        ...
        static String _266 = "length after append";
        String *_266_ref = &_266;
        TestState _267 = Test_assert_MINUS_equal__int_String(test, 5, _265, _266_ref);
        TestState* _1000045 = &_267; // ref
        test = _1000045;  // (Ref Test.State r307) = (Ref Test.State r307)
        static String _275 = "";
        String *_275_ref = &_275;
        String _310;
        /* let */ {
            StringBuf _280 = StringBuf_create();
            StringBuf sb = _280;
            StringBuf* _286 = &sb; // ref
            static String _287 = "hello";
            String *_287_ref = &_287;
            StringBuf_append_MINUS_str(_286, _287_ref);
            StringBuf* _292 = &sb; // ref
            StringBuf_clear(_292);
            String _308;
            /* let */ {
                StringBuf* _299 = &sb; // ref
                String _300 = StringBuf_to_MINUS_string(_299);
                String s = _300;
                StringBuf_delete(sb);
                String _307 = s;
                _308 = _307;
        ...
        String* _311 = &_310; // ref
        static String _312 = "clear resets to empty";
        String *_312_ref = &_312;
        TestState _313 = Test_assert_MINUS_equal__String_MUL__String(test, _275_ref, _311, _312_ref);
        TestState* _1000052 = &_313; // ref
        test = _1000052;  // (Ref Test.State r307) = (Ref Test.State r307)
        static String _321 = "hello";
        String *_321_ref = &_321;
        String _363;
        /* let */ {
            StringBuf _326 = StringBuf_create();
            StringBuf sb = _326;
            StringBuf* _332 = &sb; // ref
            static String _333 = "hello";
            String *_333_ref = &_333;
            StringBuf_append_MINUS_str(_332, _333_ref);
            String _361;
            /* let */ {
                StringBuf* _340 = &sb; // ref
                String _341 = StringBuf_str(_340);
                String s1 = _341;
                StringBuf* _346 = &sb; // ref
                String _347 = StringBuf_str(_346);
                String s2 = _347;
                StringBuf_delete(sb);
                /* let */ {
                    String _ = s2;
        ...
        String* _364 = &_363; // ref
        static String _365 = "str copies without consuming";
        String *_365_ref = &_365;
        TestState _366 = Test_assert_MINUS_equal__String_MUL__String(test, _321_ref, _364, _365_ref);
        TestState* _1000059 = &_366; // ref
        test = _1000059;  // (Ref Test.State r307) = (Ref Test.State r307)
        static String _374 = "second";
        String *_374_ref = &_374;
        String _420;
        /* let */ {
            StringBuf _379 = StringBuf_create();
            StringBuf sb = _379;
            StringBuf* _385 = &sb; // ref
            static String _386 = "first";
            String *_386_ref = &_386;
            StringBuf_append_MINUS_str(_385, _386_ref);
            /* let */ {
                StringBuf* _393 = &sb; // ref
                String _394 = StringBuf_to_MINUS_string(_393);
                String _ = _394;
                /* () */
                String_delete(_);
            }
            StringBuf* _401 = &sb; // ref
            static String _402 = "second";
            String *_402_ref = &_402;
            StringBuf_append_MINUS_str(_401, _402_ref);
            String _418;
            /* let */ {
                StringBuf* _409 = &sb; // ref
                String _410 = StringBuf_to_MINUS_string(_409);
                String s = _410;
                StringBuf_delete(sb);
                String _417 = s;
                _418 = _417;
        ...
        String* _421 = &_420; // ref
        static String _422 = "to-string resets, buffer is reusable";
        String *_422_ref = &_422;
        TestState _423 = Test_assert_MINUS_equal__String_MUL__String(test, _374_ref, _421, _422_ref);
        TestState* _1000067 = &_423; // ref
        test = _1000067;  // (Ref Test.State r307) = (Ref Test.State r307)
        int _480;
        /* let */ {
            StringBuf _435 = StringBuf_create();
            StringBuf sb = _435;
            /* let */ {
                int i = 0;
                bool _1000082 = Int__LT_(i, 1000);
                bool _1000080 = _1000082;
                while (_1000080) {
                    StringBuf* _451 = &sb; // ref
                    StringBuf_append_MINUS_char(_451, 120/*'x'*/);
                    int _1000087 = Int__PLUS_(i, 1);
                    i = _1000087;  // Int = Int
                    bool _1000082 = Int__LT_(i, 1000);
                    _1000080 = _1000082;
                }
            ...
            int _478;
            /* let */ {
                StringBuf* _469 = &sb; // ref
                int _470 = StringBuf_length(_469);
                int l = _470;
                StringBuf_delete(sb);
                int _477 = l;
                _478 = _477;
        ...
        static String _481 = "1000 char appends";
        String *_481_ref = &_481;
        TestState _482 = Test_assert_MINUS_equal__int_String(test, 1000, _480, _481_ref);
        TestState* _1000075 = &_482; // ref
        test = _1000075;  // (Ref Test.State r307) = (Ref Test.State r307)
        Test_print_MINUS_test_MINUS_results(test);
        int* _1000092 = Test_State_failed(test);
        int _1000091 = Int_copy(_1000092);
        int _1000007 = _1000091;
        _1000003 = _1000007;
        String_delete(_101);
        String_delete(_148);
        String_delete(_194);
        ...
        Test_State_delete(_104);
        Test_State_delete(_151);
        Test_State_delete(_197);
        Test_State_delete(_228);
        Test_State_delete(_267);
        Test_State_delete(_313);
        Test_State_delete(_366);
        Test_State_delete(_423);
        Test_State_delete(_482);
